...
_i = _safe_import('core.waf_evasion_engine', ['WAFFingerprinter', 'WAFEvasionEngine', 'run_waf_scan']); WAFFingerprinter = _i['WAFFingerprinter']; WAFEvasionEngine = _i['WAFEvasionEngine']; run_waf_scan = _i['run_waf_scan']
